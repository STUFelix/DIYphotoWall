...
public class PhotoWallAdapter extends ArrayAdapter<String> implements AbsListView.OnScrollListener {
    ...
    public PhotoWallAdapter(@NonNull Context context, int textViewResourceID,String[] objects,GridView photoWall) {
    ...
    class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
        ...
        private Bitmap downloadBitmap(String imageUrl) {
            ...
            try {
                ...
                //bitmap =mImageResizer.decodeFormStream(is,90,90);
